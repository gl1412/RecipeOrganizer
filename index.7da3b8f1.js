function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis,r={},n={},i=t.parcelRequire94c2;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequire94c2=i);var s=i.register;s("6FvfU",function(t,r){e(t.exports,"db",()=>l),e(t.exports,"auth",()=>u),e(t.exports,"provider",()=>h),e(t.exports,"AI_API_KEY",()=>c),e(t.exports,"AI_API_URL",()=>f),e(t.exports,"collection",()=>i("9HrqM").collection),e(t.exports,"addDoc",()=>i("9HrqM").addDoc),e(t.exports,"getDocs",()=>i("9HrqM").getDocs),e(t.exports,"deleteDoc",()=>i("9HrqM").deleteDoc),e(t.exports,"doc",()=>i("9HrqM").doc),e(t.exports,"updateDoc",()=>i("9HrqM").updateDoc),e(t.exports,"signInWithPopup",()=>i("guynj").c),e(t.exports,"signOut",()=>i("guynj").C),e(t.exports,"query",()=>i("9HrqM").query),e(t.exports,"where",()=>i("9HrqM").where),i("fhN3L");var n=i("7xvHX");i("ilpIi");var s=i("9HrqM");i("6AR8M");var o=i("guynj");let a=(0,n.initializeApp)({apiKey:"AIzaSyAR3nIRsgdpGlWjuzSdkhW0H2VRH0akO0c",authDomain:"myfavoriterecipes-5526a.firebaseapp.com",projectId:"myfavoriterecipes-5526a",storageBucket:"myfavoriterecipes-5526a.firebasestorage.app",messagingSenderId:"366652481829",appId:"1:366652481829:web:0099eeead73a4641f63acc"}),l=(0,s.getFirestore)(a),u=(0,o.o)(a),h=new o.X,c="AIzaSyCSLoY1z-EdR-uBpa9OQKbTI4KXIYABSnE",f="https://generativelanguage.googleapis.com/v1/models/gemini-pro:generateContent"}),s("fhN3L",function(t,r){e(t.exports,"initializeApp",()=>i("7xvHX").initializeApp),e(t.exports,"registerVersion",()=>i("7xvHX").registerVersion),/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function te(e,t,r=!1){if((0,s._isFirebaseServerApp)(e.app))return Promise.reject(y(e));let n="signIn",i=await e4(e,n,t),o=await e3._fromIdTokenResponse(e,n,i);return r||await e._updateCurrentUser(o.user),o}function tt(e){return(0,o.getModularInstance)(e).signOut()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
