...
async function addRecipeToFirestore(name, ingredients, category) {
    ...
    try {
        await (0, _firebaseJs.addDoc)((0, _firebaseJs.collection)((0, _firebaseJs.db), "recipes"), {
            email: email,
            name: name,
...
async function editRecipe(recipeId, currentName, currentIngredients, currentCategory) {
    ...
    if (newName && newIngredients) try {
        await (0, _firebaseJs.updateDoc)((0, _firebaseJs.doc)((0, _firebaseJs.db), "recipes", recipeId), {
            name: newName,
...
async function getAIResponse(userInput) {
    ...
    try {
        const response = await fetch(`${(0, _firebaseJs.AI_API_URL)}?key=${(0, _firebaseJs.AI_API_KEY)}`, {
            method: "POST",
            headers: {
...
},{"bd4ba1843f7ed88e":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
